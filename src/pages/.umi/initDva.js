...
app.model({ namespace: 'cabinTypeCodes', ...(require('E:/zhm/umicmstest01/src/models/cabinTypeCodes.js').default) });
app.model({ namespace: 'columns', ...(require('E:/zhm/umicmstest01/src/models/columns.js').default) });
